...
if ($(window).width() < 769) {
    $('sub').css({width: $(window).width() - $(window).width()*0.2 + 'px'});
    let myShapesMobileLanding = {
        ...
        data: {
            ...
            fromTop:5,
            toBottom:$containerMobileLanding.height()-20,
            fromLeft: -90,
            fromRight:$containerMobileLanding.width(),
            fromWidth: 5,
            toWidth: 40,
            fromHeight:1,
        },
...
$mobileMenu.css({right:$(window).width() + 'px', width:$(window).width() + 'px'});
...
let myShapesMobile = {
    ...
    data: {
        ...
        fromTop:0,
        toBottom:$containerMobile.height(),
        fromLeft: 50,
        fromRight:$containerMobile.width() - 10,
        fromWidth: 5,
        toWidth: 40,
        fromHeight:1,
    },
